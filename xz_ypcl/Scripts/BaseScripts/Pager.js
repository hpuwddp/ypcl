    ...
    var pager = {
        ...
        bindEvent: function (obj, page) {
            ...
            return (function () {
                ...
                //首页
                obj.find('a.firstPage').bind('click', function () {

                    if (typeof (page.backFn == "function")) {
                        page.backFn(1, page.pageSize);
                    }
                    pager.fillHtml(obj, { "pageIndex": 1, "totalPage": page.totalPage });
                });
                //尾页
                obj.find('a.endPage').bind('click', function () {

                    if (typeof (page.backFn == "function")) {
                        page.backFn(page.totalPage, page.pageSize);
                    }
