...
namespace xz_ypcl.Aspx
{
    public partial class AliPay : System.Web.UI.Page
    {
        ...
        protected void BtnAlipay_Click(object sender, EventArgs e)
        {
            ...
            // 设置同步回调地址
            request.SetReturnUrl("http://pay.jianyaotech.cn/Aspx/AliPayReturn_url.aspx");
            // 设置异步通知接收地址
            request.SetNotifyUrl("http://pay.jianyaotech.cn/Aspx/AliPayNotify_url.aspx");
            // 将业务model载入到request
